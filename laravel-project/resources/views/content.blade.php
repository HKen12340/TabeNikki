...
<div class="border p-4 col-7 m-auto mt-5 mb-5">
    ...
    <div style="margin:auto">
        ...
        <div style="display:flex;justify-content:center;">
            <div class="col-8 row-4">
                ...
                <img src={{ asset(optional($item->image)->food_img) }}  style="width: 100%;" alt="">
            </div>
        </div>  
    ...
    <h2 class="col-8" style="margin:auto">{{$item->shop_name}}の店舗写真</h2>
    <div class="col-8" style="margin:auto;display:flex;justify-content:center">
        <img src={{ asset(optional($item->image)->shop_img) }} style="width: 100%;height:60%;" alt="">
    </div>
</div>
@endsection
